...
public class Hardware {
    ...
    public void initHardware(){
        ...
        }catch (Exception e){opMode.telemetry.addLine("Something went wrong when configuring the drive motors.");}
        ...
        } catch(Exception e){opMode.telemetry.addLine("Crane Arm Motor3 were not found in config");}
